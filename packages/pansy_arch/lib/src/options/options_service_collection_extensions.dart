...
import 'package:pansy_arch/src/options/options_manager.dart';
import 'package:pansy_arch/src/options/options_manager_extensions.dart';
import 'package:pansy_arch/src/options/options_manager_impl.dart';
import 'package:pansy_arch/src/options/options_provider.dart';
import 'package:pansy_arch/src/options/options_provider_impl.dart';
...
extension OptionsServiceCollectionExtensions on ServiceCollection {
  ...
  void configureNamed<TOptions extends Object>(
    ...
    addTransientFactory<TOptions>(
      (provider) => provider.getRequired<OptionsManager>().getRequired<TOptions>(),
    );
  }
}
